 ...
 *------------------------------------------------------------------*/
 ...
 module conv2_layer (
   ...
   output valid_out_conv2   // FIXED: Changed from 'output reg' to 'output' (wire)
 );
 ...
 assign valid_out_conv2 = valid_out_calc_1 & valid_out_calc_2 & valid_out_calc_3;  // Now this works!
